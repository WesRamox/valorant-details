    ...
    <section className="agents z-50 flex flex-wrap w-[35rem] gap-1">
      {agents
        ...
        .map(agent => (
          <button
            key={agent.uuid}
            className="border-[1px] hover:border-yellow-200 bg-transparent p-0 disabled:cursor-pointer disabled:border-yellow-200 disabled:border-[1px] disabled:bg-yellow-100 disabled:bg-opacity-20"
